...
<![endif]-->
<link href="${pageContext.request.contextPath }/pageResources/static/h-ui/css/H-ui.min.css" rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath }/pageResources/static/h-ui.admin/css/H-ui.login.css" rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath }/pageResources/static/h-ui.admin/css/style.css" rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath }/pageResources/lib/Hui-iconfont/1.0.8/iconfont.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
    ...
    <form class="form form-horizontal" action="">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input  name="mobile" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="${pageContext.request.contextPath }/verify-code" id="vcode_img"> <a id="changeCode" href="javascript:;">看不清，换一张</a> </div>
      </div>
      <div class="row cl">
        <!-- <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <button id='loginBtn' type="button" class="btn btn-success radius size-L">&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;</button>
		...
		$.ajax({
			...
			success: function(data){
                if(data.result){
                    ...
                    setTimeout(function(){
						location.href='${pageContext.request.contextPath }/dispatcher?view=/admin/main/index';
					}, 1000);//1秒后刷新界面
				}else {
