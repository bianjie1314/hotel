	...
	<form class="form form-horizontal" action="">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${modifyMenuInfo.name}" placeholder="输入菜单名称" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>链接：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${modifyMenuInfo.url}" placeholder="输入链接" name="url">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>图标：</label>
			<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${modifyMenuInfo.icon}" placeholder="输入图标" name="icon">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" value="${modifyMenuInfo.index}" placeholder="显示顺序" name="index">
			</div>
		</div>
		<div class="row cl">
...
$("#statusSelect").val("${modifyMenuInfo.status}");
var parentId = ${modifyMenuInfo.parentId};
if (parentId != 0){	//父菜单
	$("#firstMenu").val("2");//二级菜单
		$.ajax({
			type : 'get',
