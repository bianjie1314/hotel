	...
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${hotelInfo.name}" placeholder="输入酒店名称" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">位置：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="location" id="location" placeholder="输入地理位置" value="${hotelInfo.location}" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">营业时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="openTime" id="openTime" placeholder="输入营业时间" value="${hotelInfo.openTime}" class="input-text">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<fmt:formatDate value="${hotelInfo.createTime}" pattern="yyyy年MM月dd日HH点mm分ss秒" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">更新时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<fmt:formatDate value="${hotelInfo.updateTime}" pattern="yyyy年MM月dd日HH点mm分ss秒" />
			</div>
		</div>
		<div class="row cl">
			...
			<div class="image-more">
				<ul class="row">
					<c:if test="${hotelInfo.pictures != null }">
						<c:forEach items="${hotelInfo.pictures }" var="pic" varStatus="status">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="formSubmit();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 确认修改</button>
...
function formSubmit(){
    if ($("[name='name']").val() == null || $("[name='name']").val() == ""){
        ...
        return;
    }else if($("[name='openTime']").val() == null || $("[name='openTime']").val() == ""){
        layer.msg("输入营业时间",{icon:5,time:3000});
        return;
    }else {
        layer.confirm('确认添更新吗？',function(index){
            $.ajax({
                type: 'post',
