	...
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="输入酒店名称" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="openTime" id="openTime" placeholder="输入营业时间" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
    ...
    function formSubmit(){
        if ($("[name='name']").val() == null || $("[name='name']").val() == ""){
            ...
            layer.confirm('确认添加吗？',function(index){
                $.ajax({
                    type: 'post',
                    url: '${pageContext.request.contextPath }/hotel/add',
                    dataType: 'json',
