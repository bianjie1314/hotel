...
<div class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${roomInfo.number}" placeholder="输入房间编号" id="number" name="number">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">面积：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" name="area" id="area" min="1" placeholder="输入面积" value="${roomInfo.area}" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">房费：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" name="money" id="money" placeholder="输入房费" min="1" value="${roomInfo.money}" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">押金：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" name="deposit" id="deposit" placeholder="输入押金" min="0" value="${roomInfo.deposit}" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">是否有独卫：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<select name="toilet"class="select" id="toilet">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select name="window"class="select" id="window">
					<option value="1" selected="selected">有</option>
					<option value="2">无</option>
				</select>
			</div>
...
$("#status").val("${roomInfo.status}");
$("#window").val("${roomInfo.window}");
$("#toilet").val("${roomInfo.toilet}");
