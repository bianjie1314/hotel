...
<header class="container">
	<div class="row">
		<div class="col-md-4">
			<div id="logo"><img src="${pageContext.request.contextPath }/clientlib/images/lo3.png" style="width: 300px;height: 50px;" /></div>
		</div>
		<div class="col-md-4">
			<form class="form-search">
				<input type="text" name="searchText" placeholder="酒店名称/地理位置"  class="input-medium search-query">
				<button type="button"  onclick="searchHotel(null)" class="btn"><span class="glyphicon glyphicon-search"></span></button>
			</form>
		</div>
		<div class="col-md-4">
		</div>
